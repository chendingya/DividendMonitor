...
export async function removeAssetFromWatchlistGroup(request: WatchlistGroupAssetActionDto): Promise<void> {
  ...
  return repository.removeFromGroup(request.groupId, request.assetKey)
}
